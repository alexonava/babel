...
The default camera opens on The watch and tours seven directed shots, each held 6 to 9 seconds and joined by a 1-second dissolve that changes the sky first, then the mountains, ground and subject, skipping Masonry study. The owner retired the footer's Pause scene control on 2026-09-24; About holds the footer's right corner, and the scene always plays (reduced motion, hidden tabs and open dialogs still pause it). Add view=tower&angle=1&tour=0 to the preview URL for a held review composition, or tour=5 for the faster review cadence. Full framing rules and legacy comparisons are in the scene-mode guide.
