...
- The default ground is the owner-approved dark cracked slate, matching the old-tower comparison views: the authored Cracked Desert Ground color and normal maps at their 1024 high / 512 balanced resolutions, on the classic ground's mirrored 22-unit tile and 0.45 normal strength, tinted warm so that under the cool film light it reads a dark slate grey near the classic ground's balance: only slightly cool in moonlight and in the fogged distance, and short of brown under the lantern. Close to the lens a finer pass of the same normal map keeps the cracks crisp. A subtle, calm wet sheen gathers in terrain hollows and dark cracks: slightly darker and smoother ground with a low, mostly neutral grazing reflection of the fog color that never lifts distant ground into a pale blue-grey veil. The tower footing, tree roots and path stay dry, and the sheen stays low behind the intro text. The earlier earth and grass maps are retained only as the `?ground=earth` comparison. Compare live views before refreshing landscape and portrait posters and the og.png share card; each final static image must represent the accepted live appearance.
