...
The cinematic tower and tree scene opens first, with the preferred 700-weight warm-white Alex Nava serif and a quiet introduction. Preserve the seven-view automatic camera tour, its per-shot holds and soft crossfades, sun, stars, and lighting. Masonry study is retained only for explicit comparison links. No loading ritual should delay the identity or About navigation.
...
- The camera tour has no shot label or control strip. Its only control is a quiet Pause scene / Play scene text button in the footer (the label names the next action): meta grey, 12px, with at least a 44px target. Preserve the per-shot holds (The watch and Portrait 14 seconds, Threshold and Gallery detail 11, Lantern study, Close-up and Root and lantern 9), the 1.2-second crossfade with no dip to black, drift that never stops before a cut, and reduced-motion/panel pauses; fixed review cadences remain available through URL parameters.
